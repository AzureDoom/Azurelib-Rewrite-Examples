...
public class CreeperRenderer { // extends AzEntityRenderer<Creeper> {
    ...
    private static final Identifier MODEL = CommonMod.modResource("geo/entity/possessed_engineer.geo.json");

    private static final Identifier TEXTURE = CommonMod.modResource("textures/entity/possessed_engineer.png");
