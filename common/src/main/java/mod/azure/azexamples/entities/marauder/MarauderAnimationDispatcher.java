...
/**
 * The MarauderAnimationDispatcher class is responsible for managing and dispatching
 * animation commands for entities, specifically tailored for the Marauder entity.
 * It uses predefined animation commands to sync animations with specific entity actions
 * such as idling, walking, running, melee attacking, spawning, or dying.
 * </br>
 * </br>
 * This dispatcher operates independently, providing a clean and centralized way to handle
 * animation transitions, triggered by client or server events.
 */
